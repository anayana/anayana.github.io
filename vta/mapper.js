...
const COLSYN = {
  tree_id: ['puu_id', 'puuid', 'puun_tunnus', 'tunnus', 'puunumero', 'puu_nro', 'kohde_id', 'puu_id', 'puuid', 'objekt_id', 'kood', 'puu_nr', 'nr_kaardil', 'tree_id', 'treeid', 'id', 'nr', 'baum_id', 'baumid', 'baumnummer', 'baum_nr', 'baumnr',
  ...
  species: ['laji', 'puulaji', 'laji_lat', 'tieteellinen_nimi', 'latinankielinen_nimi', 'kasvilaji', 'liik', 'puuliik', 'taksoni_nimi', 'ladina_nimi', 'liik_lad', 'liik_ladina', 'taimeliik', 'species', 'art', 'baum', 'baumart', 'art_bot', 'artbot', 'botanischer_name', 'botanical_name', 'lat_name',
  ...
  vitality_roloff: ['vitality_roloff', 'vitalitaet', 'vitalität', 'vitalitaetsstufe', 'roloff',
                    'vitalitaetsklasse'],
  vitality_5: ['kunto', 'elinvoima', 'yleiskunto', 'seisund', 'seisukord', 'tervislik_seisund', 'elujoulisus', 'elujõulisus', 'vitality_5', 'vitality', 'condition', 'health', 'zustand', 'conditie',
  ...
  condition_class: ['condition_class', 'kuntoluokka', 'kunto_luokka', 'zustandsklasse', 'seisundiklass', 'conditieklasse', 'condition_grade'],
  damage_class: ['vauriot', 'vaurio', 'vaurioluokka', 'kahjustus', 'kahjustused', 'kahjustuse_aste', 'damage_class', 'schadstufe', 'schadensklasse', 'schaden', 'damage',
  ...
  last_inspection: ['tarkastuspaiva', 'tarkastuspäivä', 'tarkastettu', 'kuntoarvio_pvm', 'kuupaev', 'kuupäev', 'inventeerimise_kuupaev', 'inventeerimise_kuupäev', 'inventeeritud', 'last_inspection', 'kontrolldatum', 'letzte_kontrolle', 'datum',
  ...
  interval_months: ['interval_months', 'intervall', 'kontrollintervall', 'turnus', 'interval',
                    'cyclus', 'frequency'],
  inspector: ['tarkastaja', 'arvioija', 'inventeerija', 'dendroloog', 'koostaja', 'inspector', 'kontrolleur', 'bearbeiter', 'pruefer', 'prüfer', 'sachbearbeiter',
              'controleur', 'surveyor', 'assessor', 'erfasser'],
  remarks: ['huomautus', 'huomautukset', 'lisatiedot', 'lisätiedot', 'markus', 'märkus', 'markused', 'märkused', 'kommentaar', 'remarks', 'bemerkung', 'bemerkungen', 'anmerkung', 'notiz', 'kommentar',
